...
const footer_content  = {
    title: <>Stay Updated with Our <br /> Latest Insights</>,
    description: <>Get the latest news, trends, and expert insights on technology solutions from Matrix Vision Systems.</>,
    phone: "+254 721 779 429",
    contact_mail: "info@matrixsystems.co.ke",
    location: "Mais. 7, B.S.K. Village, Muguga Greens, Westlands, Nairobi",
    ...
    footer_lisks : [
        {
            ...
            links: [
                ...
                {name: "Managed Services", link: "/services/enterprise-solutions"},
            ]
        },
        {
            id: 2,
            ...
            links: [
                ...
                {name: "Projects", link: "#"}, // You might want to create a projects page
                {name: "Blog", link: "/blog"},
                           ...
                           <div className="col-xl-4 col-lg-4 col-md-7 pb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">
                              <div className="tp-footer__widget footer-col-1">
                                 <Link href="/" className="tp-footer__widget-logo mb-10">
                                    <Image src={footer_logo} alt="Matrix Vision Systems Logo" />
                                 </Link>
