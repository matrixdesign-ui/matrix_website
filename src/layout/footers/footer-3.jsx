...
const footer_content = {
    ...
    title: <>Explore Our Technology Solutions <br /> <span>Transforming Businesses for the Future.</span></>,
    btn_text: "Discover Our Services",
    phone: "+254 721 779 429",
    email: "info@matrixsystems.co.ke",
    description: <>Partner with Matrix Vision Systems for innovative and reliable technology solutions.</>,
            ...
            <div className="container">
                <div className="row align-items-center">
                    ...
                    <div className="col-xl-3 col-lg-3">
                        ...
                        <Link className="tp-btn-blue-lg tp-btn-hover" href="/service">
                            <span>{btn_text}</span>
                            <b></b>
                        </Link>
                        </div>
